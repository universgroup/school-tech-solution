...
def recuinscription(request, idinsc):
    ...
    if ec==0:
        ...
        data = [ins.id, ins.annee_scolaire.descript_annee, ins.mateleve.matricule, ins.idclasse, ins.mateleve.nom,
                ins.mateleve.prenom,
                ins.mateleve.tuteur, ins.mateleve.contact_pere,ins.mateleve.email_pere, ins.date_inscription, ins.idclasse.frais_inscription
                ]
...
def recureinscription(request, idinsc):
    ...
    if ec==0:
        ...
        data = [ins.id, ins.annee_scolaire.descript_annee, ins.mateleve.matricule, ins.idclasse, ins.mateleve.nom,
                ins.mateleve.prenom,
                ins.mateleve.tuteur, ins.mateleve.contact_pere,ins.mateleve.email_pere, ins.date_inscription, ins.idclasse.frais_reinscription
                ]
